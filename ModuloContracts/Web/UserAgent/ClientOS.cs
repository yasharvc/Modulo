...
namespace ModuloContracts.Web.UserAgent
{
	public enum OSName
	{
		Windows,
    ...
    public class ClientOS
    {
		...
		public OSName OSName { get; private set; }
		public AgentType Type {
			get{
				if (OSName == OSName.Android || OSName == OSName.BlackBerry || OSName == OSName.iOS
					|| OSName == OSName.WindowsPhone)
					return AgentType.MobileOrTablet;
        ...
        private static void NameVersionAction(Match match, Object obj)
        {
			...
			if (current.Name.Contains("android", StringComparison.OrdinalIgnoreCase))
				current.OSName = OSName.Android;
			if (current.Name.StartsWith("ios", StringComparison.OrdinalIgnoreCase))
				current.OSName = OSName.iOS;
			if (current.Name.StartsWith("blackberry", StringComparison.OrdinalIgnoreCase))
				current.OSName = OSName.BlackBerry;
        ...
        private static List<MatchExpression> _matchs = new List<MatchExpression> {
            ...
            new MatchExpression{
                ...
                Action = (Match match, Object obj)=>{
					...
					if(current.Name.Length > 0)
						current.OSName = OSName.WindowsPhone;
            ...
            new MatchExpression{
                ...
                Action = (Match match, Object obj)=>{
					...
					current.OSName = OSName.FireFoxOS;
            ...
            new MatchExpression{
                ...
                Action = (Match match, Object obj)=>{
					...
					current.OSName = OSName.ChromeOS;
